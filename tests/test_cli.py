...
@pytest.mark.parametrize(
    ...
    [(
        ['main.py', '--locations', 'data/locations.py', '--devices', 'data/devices.py', '--events', 'data/events.py', '--format', 'json'],
        'data/locations.py',
        'data/devices.py',
        'data/events.py',
        'json'
    ...
    (
        ['main.py', '--locations', 'data/locations.py', '--devices', 'data/devices.py', '--events', 'data/events.py', '--format', 'xml'],
        'data/locations.py',
        'data/devices.py',
        'data/events.py',
        'xml'
